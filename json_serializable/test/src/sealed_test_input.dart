...
''')
@JsonSerializable(
  unionDiscriminator: 'new_discriminator',
)
...
''')
@JsonSerializable(
  unionDiscriminator: 'super_super_super_type',
)
...
''')
@JsonSerializable(
  unionDiscriminator: 'super_super_type',
)
