...
part of 'kitchen_sink.g_checked__exclude_null__explicit_to_json.dart';
...
KitchenSink _$KitchenSinkFromJson(Map<String, dynamic> json) {
  return $checkedNew('KitchenSink', json, () {
    ...
    $checkedConvert(
        json,
        'stringStringMap',
        (v) => val.stringStringMap = (v as Map<String, dynamic>)?.map(
              (k, e) => MapEntry(k, e as String),
            ));
    $checkedConvert(
        json,
        'dynamicIntMap',
        (v) => val.dynamicIntMap = (v as Map<String, dynamic>)?.map(
    ...
    $checkedConvert(
        json,
        'val',
        (v) => val.val = (v as Map<String, dynamic>)?.map(
    ...
    $checkedConvert(
        json,
        'simpleObject',
        (v) => val.simpleObject = v == null
            ? null
            : SimpleObject.fromJson(v as Map<String, dynamic>));
    $checkedConvert(
        json,
        'strictKeysObject',
        (v) => val.strictKeysObject = v == null
            ? null
...
Map<String, dynamic> _$KitchenSinkToJson(KitchenSink instance) {
  ...
  writeNotNull('simpleObject', instance.simpleObject?.toJson());
  writeNotNull('strictKeysObject', instance.strictKeysObject?.toJson());
