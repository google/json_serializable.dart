  ...
  return $checkedNew('KitchenSink', json, () {
    final val = KitchenSink(
      ...
      objectIterable: $checkedConvert(
          json, 'objectIterable', (v) => (v as List?)?.map((e) => e as Object)),
    ...
    $checkedConvert(json, 'objectSet',
        (v) => val.objectSet = (v as List).map((e) => e as Object).toSet());
    ...
    $checkedConvert(json, 'objectList',
        (v) => val.objectList = (v as List).map((e) => e as Object).toList());
