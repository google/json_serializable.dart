...
Ship _$ShipFromJson(Map<String, dynamic> json) => Ship(
      cargoCapacity: (json['cargoCapacity'] as num).toDouble(),
    );
...
GPSDevice _$GPSDeviceFromJson(Map<String, dynamic> json) => GPSDevice(
...
Map<String, dynamic> _$ContainerToJson(Container instance) =>
    switch (instance) {
      final Box instance => {
          'type': 'Box',
          ..._$BoxToJson(instance),
        },
      final Parcel instance => {
          'type': 'Parcel',
          ..._$ParcelToJson(instance),
        },
    };
