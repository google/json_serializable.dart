...
JsonKey _from(FieldElement element, JsonSerializable classAnnotation) {
  ...
  return _populateJsonKey(
    ...
    ignoreEncode: obj.read('ignoreEncode').literalValue as bool,
    ignoreDecode: obj.read('ignoreDecode').literalValue as bool,
...
JsonKey _populateJsonKey(
  ...
  final jsonKey = JsonKey(
    ...
    ignore: ignore ?? false,
    ignoreDecode: ignoreDecode ?? false,
    ignoreEncode: ignoreEncode ?? false,
